...
Begin VB.Form frmProjetoSimplificado 
   ...
   Begin TabDlg.SSTab SSTab2 
      ...
      Begin VB.TextBox txtIdLote 
         ...
         Left            =   -74760
         TabIndex        =   28
         Text            =   "2f3d459a-d5e5-4533-8084-309cddff5f1a"
         Top             =   2640
         Width           =   7695
      End
      ...
      Begin VB.ComboBox cbAmbiente 
         Height          =   315
         ItemData        =   "frmProjetoSimplificado.frx":0075
         Left            =   5640
         List            =   "frmProjetoSimplificado.frx":007F
         TabIndex        =   7
         Top             =   840
         Width           =   2295
      End
      ...
      Begin VB.Label lbAvisoSimp 
         Caption         =   $"frmProjetoSimplificado.frx":00A2
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmProjetoSimplificado.frx":012A
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "tbRetorno"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Xml de Envio"
      TabPicture(1)   =   "frmProjetoSimplificado.frx":0146
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "tbXmlEnvio"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Xml de Retorno"
      TabPicture(2)   =   "frmProjetoSimplificado.frx":0162
      Tab(2).ControlEnabled=   0   'False
...
Public eSocial As ESocialS11ClientX.spdESocialS11ClientX
...
Private Sub cmdConsultar_Click()
    Dim RetConsulta As spdS11RetConsultarLote
    Dim RetConsultaItem As spdS11RetConsultarLoteItem
    Dim RetConsultaOcorrencia As spdS11RetConsultarLoteOcorrencia
    Dim RetConsultaOcorrenciaEnvio As spdS11RetConsultarLoteOcorrenciaEnvio
            ...
            For b = 0 To RetConsultaItem.S5003.InfoFGTS.IdeEstab(a).CountIdeLotacao - 1
                ...
                Next c
                  For c = 0 To RetConsultaItem.S5003.InfoFGTS.IdeEstab(a).IdeLotacao(b).CountInfoTrabFGTS - 1
                        ...
                        If (RetConsultaItem.S5003.InfoFGTS.IdeEstab(a).IdeLotacao(b).InfoTrabFGTS(c).SucessaoVinc.TpInsc = Null) Then
                      ...
                      For d = 0 To RetConsultaItem.S5003.InfoFGTS.IdeEstab(a).IdeLotacao(b).InfoTrabFGTS(c).CountInfoBaseFGTS - 1
                       ...
                       tbRetorno.Text = tbRetorno.Text & "              TpValor: " & RetConsultaItem.S5003.InfoFGTS.IdeEstab(a).IdeLotacao(b).InfoTrabFGTS(c).InfoBaseFGTS(d).BasePerApur(d).TpValor & vbNewLine
                       tbRetorno.Text = tbRetorno.Text & "              IndIncid: " & RetConsultaItem.S5003.InfoFGTS.IdeEstab(a).IdeLotacao(b).InfoTrabFGTS(c).InfoBaseFGTS(d).BasePerApur(d).IndIncid & vbNewLine
                       tbRetorno.Text = tbRetorno.Text & "              RemFGTS: " & RetConsultaItem.S5003.InfoFGTS.IdeEstab(a).IdeLotacao(b).InfoTrabFGTS(c).InfoBaseFGTS(d).BasePerApur(d).RemFGTS & vbNewLine
                       tbRetorno.Text = tbRetorno.Text & "              DpsFGTS: " & RetConsultaItem.S5003.InfoFGTS.IdeEstab(a).IdeLotacao(b).InfoTrabFGTS(c).InfoBaseFGTS(d).BasePerApur(d).DpsFGTS & vbNewLine
                       
                      
                        For e = 0 To RetConsultaItem.S5003.InfoFGTS.IdeEstab(a).IdeLotacao(b).InfoTrabFGTS(c).InfoBaseFGTS(d).BasePerApur(d).CountDetRubrSusp - 1
                                
                            tbRetorno.Text = tbRetorno.Text & "              DetRubrSusp: " & vbNewLine
                            tbRetorno.Text = tbRetorno.Text & "              CodRubr: " & RetConsultaItem.S5003.InfoFGTS.IdeEstab(a).IdeLotacao(b).InfoTrabFGTS(c).InfoBaseFGTS(d).BasePerApur(d).DetRubrSusp(e).CodRubr & vbNewLine
                            tbRetorno.Text = tbRetorno.Text & "              IdeTabRubr: " & RetConsultaItem.S5003.InfoFGTS.IdeEstab(a).IdeLotacao(b).InfoTrabFGTS(c).InfoBaseFGTS(d).BasePerApur(d).DetRubrSusp(e).IdeTabRubr & vbNewLine
...
Set eSocial = New ESocialS11ClientX.spdESocialS11ClientX
eSocial.ConfigurarSoftwareHouse "08187168000160", "0000000000000000000000"
