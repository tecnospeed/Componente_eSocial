...
Begin VB.Form frmProjetoSimplificado 
   ...
   Begin TabDlg.SSTab SSTab2 
      ...
      Tab(0).Control(0)=   "txtPincode"
      Tab(0).Control(1)=   "cbGrupo"
      Tab(0).Control(2)=   "cbCertificado"
      Tab(0).Control(3)=   "cbVersao"
      Tab(0).Control(4)=   "btnConfigurar"
      Tab(0).Control(5)=   "txtEsquemas"
      Tab(0).Control(6)=   "txtTemplates"
      Tab(0).Control(7)=   "txtCnpjSH"
      Tab(0).Control(8)=   "txtTokenSh"
      Tab(0).Control(9)=   "cbAmbiente"
      Tab(0).Control(10)=   "txtTransmissor"
      Tab(0).Control(11)=   "txtEmpregador"
      Tab(0).Control(12)=   "lbAvisoSimp"
...
Private Sub cmdConsultar_Click()
    ...
    '--------------------S5002--------------------
        ...
        For a = 0 To RetConsultaItem.S5002.IdeTrabalhador.CountDmDev - 1
            ...
            For b = 0 To RetConsultaItem.S5002.IdeTrabalhador.DmDev(a).CountTotApurMen - 1
                ...
                tbRetorno.Text = tbRetorno.Text & " VlrCRMenSusp: " & RetConsultaItem.S5002.IdeTrabalhador.DmDev(a).TotApurMen(b).VlrCRMenSusp & vbNewLine
                tbRetorno.Text = tbRetorno.Text & "" & vbNewLine
            Next b
            ...
            For b = 0 To RetConsultaItem.S5002.IdeTrabalhador.DmDev(a).CountTotApurDia - 1
                ...
                tbRetorno.Text = tbRetorno.Text & " VlrCRDiaSusp: " & RetConsultaItem.S5002.IdeTrabalhador.DmDev(a).TotApurDia(b).VlrCRDiaSusp & vbNewLine
                tbRetorno.Text = tbRetorno.Text & "" & vbNewLine
            Next b
    ...
    '--------------------S5012--------------------
        ...
        For a = 0 To RetConsultaItem.S5012.InfoIRRF.CountInfoCRMen - 1
            ...
            tbRetorno.Text = tbRetorno.Text & " VrCRMenSusp: " & RetConsultaItem.S5012.InfoIRRF.InfoCRMen(a).VrCRMenSusp & vbNewLine
            tbRetorno.Text = tbRetorno.Text & "" & vbNewLine
        Next a
        ...
        For a = 0 To RetConsultaItem.S5012.InfoIRRF.CountInfoCRDia - 1
            ...
            tbRetorno.Text = tbRetorno.Text & " VrCRDiaSusp: " & RetConsultaItem.S5012.InfoIRRF.InfoCRDia(a).VrCRDiaSusp & vbNewLine
            tbRetorno.Text = tbRetorno.Text & "" & vbNewLine
        Next a
    End If
...
Private Sub cmdEnviar_Click()
    Dim RetEnvio As spdS11RetEnviarLoteEventos
