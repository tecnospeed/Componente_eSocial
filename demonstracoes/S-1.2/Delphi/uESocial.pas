...
var
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            mmoRetorno.Lines.Add('InfoProcJudRub');
        ...
        for _b := 0 to _RetConsultaItem.S5002.IdeTrabalhador.DmDev[_a].InfoRRA.CountIdeAdv - 1 do
        begin
          mmoRetorno.Lines.Add('IdeAdv');
          mmoRetorno.Lines.Add(' TpInsc: ' + _RetConsultaItem.S5002.IdeTrabalhador.DmDev[_a].InfoRRA.IdeAdv[_b].TpInsc);
          mmoRetorno.Lines.Add(' NrInsc: ' + _RetConsultaItem.S5002.IdeTrabalhador.DmDev[_a].InfoRRA.IdeAdv[_b].NrInsc);
          mmoRetorno.Lines.Add(' VlrAdv: ' + _RetConsultaItem.S5002.IdeTrabalhador.DmDev[_a].InfoRRA.IdeAdv[_b].VlrAdv);
          mmoRetorno.Lines.Add('');
        end;
      ...
      begin
        ...
        begin
          mmoRetorno.Lines.Add('PrevidCompl');
          mmoRetorno.Lines.Add('        TpRend: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoIRCR[_a].PrevidCompl[_b].TpPrev);
          mmoRetorno.Lines.Add('        CpfDep: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoIRCR[_a].PrevidCompl[_b].CnpjEntidPC);
          mmoRetorno.Lines.Add(' VlrDedPenAlim: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoIRCR[_a].PrevidCompl[_b].VlrDedPC);
          mmoRetorno.Lines.Add(' VlrDedPenAlim: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoIRCR[_a].PrevidCompl[_b].VlrPatrocFunp);
          mmoRetorno.Lines.Add('');
        end;
        ...
        begin
          mmoRetorno.Lines.Add('InfoProcRet');
          mmoRetorno.Lines.Add('        TpRend: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoIRCR[_a].InfoProcRet[_b].TpProcRet);
          mmoRetorno.Lines.Add('        CpfDep: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoIRCR[_a].InfoProcRet[_b].NrProcRet);
          mmoRetorno.Lines.Add(' VlrDedPenAlim: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoIRCR[_a].InfoProcRet[_b].CodSusp);
          mmoRetorno.Lines.Add('');
          ...
          begin
            mmoRetorno.Lines.Add('InfoValores');
      ...
      begin
        mmoRetorno.Lines.Add('PlanSaude');
        ...
        begin
          mmoRetorno.Lines.Add('InfoDepSau');
      ...
      for _b := 0 to _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.CountInfoReembMed - 1 do
      begin
        mmoRetorno.Lines.Add('InfoReembMed');
        mmoRetorno.Lines.Add(' IndOrgReemb: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].IndOrgReemb);
        mmoRetorno.Lines.Add('    CnpjOper: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].CnpjOper);
        mmoRetorno.Lines.Add('      RegANS: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].RegANS);
        mmoRetorno.Lines.Add('');

        //Informação de reembolso do titular do plano de saúde coletivo empresarial.
        for _c := 0 to _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].CountDetReembTit - 1 do
        begin
          mmoRetorno.Lines.Add('DetReembTit');
          mmoRetorno.Lines.Add('      TpInsc: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].DetReembTit[_c].TpInsc);
          mmoRetorno.Lines.Add('      NrInsc: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].DetReembTit[_c].NrInsc);
          mmoRetorno.Lines.Add('    VlrReemb: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].DetReembTit[_c].VlrReemb);
          mmoRetorno.Lines.Add(' VlrReembAnt: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].DetReembTit[_c].VlrReembAnt);
        end;

        //Informação de reembolso do dependente do plano de saúde coletivo empresarial.
        for _c := 0 to _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].CountInfoReembDep - 1 do
        begin
          mmoRetorno.Lines.Add('detReembTit');
          mmoRetorno.Lines.Add(' CpfBenef: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].InfoReembDep[_c].CpfBenef);
          mmoRetorno.Lines.Add('');
          ...
          for _d := 0 to _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].InfoReembDep[_c].CountDetReembDep - 1 do
          begin
            mmoRetorno.Lines.Add('DetReembDep');
            mmoRetorno.Lines.Add('      TpInsc: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].InfoReembDep[_c].DetReembDep[_d].TpInsc);
            mmoRetorno.Lines.Add('      NrInsc: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].InfoReembDep[_c].DetReembDep[_d].NrInsc);
            mmoRetorno.Lines.Add('    VlrReemb: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].InfoReembDep[_c].DetReembDep[_d].VlrReemb);
            mmoRetorno.Lines.Add(' VlrReembAnt: ' + _RetConsultaItem.S5002.IdeTrabalhador.InfoIRComplem.InfoReembMed[_b].InfoReembDep[_c].DetReembDep[_d].VlrReembAnt);
            mmoRetorno.Lines.Add('');
  ...
  begin
    ...
    begin
      ...
      begin
        mmoRetorno.Lines.Add('infoTrabFGTS');
        mmoRetorno.Lines.Add(' Matricula: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].Matricula);
        mmoRetorno.Lines.Add('  CodCateg: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].CodCateg);
        mmoRetorno.Lines.Add(' CategOrig: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].CategOrig);
        mmoRetorno.Lines.Add('');

        //Informações relativas ao FGTS do processo trabalhista.
        mmoRetorno.Lines.Add('infoTrabFGTS');
        mmoRetorno.Lines.Add(' TotalFGTS: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].InfoFGTSProcTrab.TotalFGTS);
        mmoRetorno.Lines.Add('');

        // Identificação do estabelecimento responsável pelo pagamento ao trabalhador dos valores informados.
        mmoRetorno.Lines.Add('ideEstab');
        mmoRetorno.Lines.Add(' TpInsc: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].InfoFGTSProcTrab.IdeEstab.TpInsc);
        mmoRetorno.Lines.Add(' NrInsc: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].InfoFGTSProcTrab.IdeEstab.NrInsc);
        mmoRetorno.Lines.Add('');
        ...
        begin
          ...
          mmoRetorno.Lines.Add(' CategOrig: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].InfoFGTSProcTrab.IdeEstab.BasePerRef[_b].PerRef);
          mmoRetorno.Lines.Add(' CategOrig: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].InfoFGTSProcTrab.IdeEstab.BasePerRef[_b].CodCateg);
          mmoRetorno.Lines.Add(' CategOrig: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].InfoFGTSProcTrab.IdeEstab.BasePerRef[_b].TpValorProcTrab);
          mmoRetorno.Lines.Add(' CategOrig: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].InfoFGTSProcTrab.IdeEstab.BasePerRef[_b].RemFGTSProcTrab);
          mmoRetorno.Lines.Add(' CategOrig: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].InfoFGTSProcTrab.IdeEstab.BasePerRef[_b].DpsFGTSProcTrab);
          mmoRetorno.Lines.Add(' CategOrig: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].InfoFGTSProcTrab.IdeEstab.BasePerRef[_b].RemFGTSSefip);
          mmoRetorno.Lines.Add(' CategOrig: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].InfoFGTSProcTrab.IdeEstab.BasePerRef[_b].DpsFGTSSefip);
          mmoRetorno.Lines.Add(' CategOrig: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].InfoFGTSProcTrab.IdeEstab.BasePerRef[_b].RemFGTSDecAnt);
          mmoRetorno.Lines.Add(' CategOrig: ' + _RetConsultaItem.S5503.InfoTrabFGTS[_a].InfoFGTSProcTrab.IdeEstab.BasePerRef[_b].DpsFGTSDecAnt);
          mmoRetorno.Lines.Add('');
        end;
      end;
    end;
